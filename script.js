const questions = [
            ...
            { question: "Ο/Η/Το καθένας/μια/να έχει δικαίωμα να είναι ο εαυτός του, και αυτό είναι πλεονέκτημα.", correctAnswer: "Σωστό", explanation: "Η ορατότητα και η αποδοχή ενισχύουν την ασφάλεια και την παραγωγικότητα στον χώρο εργασίας." },
            ...
            { question: "Το αρκτικόλεξο ΛΟΑΤΚΙΑ+ αντιπροσωπεύει τη διαφορετικότητα της κοινότητας.", correctAnswer: "Σωστό", explanation: "Το ΛΟΑΤΚΙΑ+ (Λεσβίες, Ομοφυλόφιλοι, Αμφιφυλόφιλοι, Τρανς, Κουήρ, Ίντερσεξ, Ασέξουαλ) είναι ένα ευρύ αρκτικόλεγκο που περιλαμβάνει διάφορες σεξουαλικές ταυτότητες και ταυτότητες φύλου." },
